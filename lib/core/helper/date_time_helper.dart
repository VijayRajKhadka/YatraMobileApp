class DateTimeHelper{
  ...
  static String timeAfter(String dateTimeString) {
    ...
    if (difference.inDays > 365) {
      ...
      return '${difference.inDays} day${difference.inDays == 1 ? '' : 's'} later';
    } else if (difference.inHours >= 1) {
      return '${difference.inHours} hour${difference.inHours == 1 ? '' : 's'} later';
    } else if (difference.inMinutes >= 1) {
      return '${difference.inMinutes} minute${difference.inMinutes == 1 ? '' : 's'} later';
    } else {
      return 'soon';
    }
  }
